...
public class TodoListDisplayItemAdapter extends ArrayAdapter<TodoListItem>{
	...
	public TodoListDisplayItemAdapter(Context context, int resource, List<TodoListItem> objects, ICreateCallToTodoListItemClick mListener) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView == null){
			...
			viewHolder.title = (TextView) (TextView) convertView.findViewById(R.id.todo_list_textViewDisplayTitle);
			viewHolder.details = (TextView) convertView.findViewById(R.id.todo_list_textViewDisplayPrice);
			viewHolder.checked = (CheckBox) convertView.findViewById(R.id.todo_list_checkBox_checked);
