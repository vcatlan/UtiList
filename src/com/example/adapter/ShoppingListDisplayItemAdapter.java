...
public class ShoppingListDisplayItemAdapter extends ArrayAdapter<ShoppingListItem>{
	...
	public ShoppingListDisplayItemAdapter(Context context, int resource, List<ShoppingListItem> objects, ICreateCallToShoppingListItemClick mListener) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView == null){
			...
			viewHolder.title = (TextView) (TextView) convertView.findViewById(R.id.textViewDisplayTitle);
			viewHolder.details = (TextView) convertView.findViewById(R.id.textViewDisplayPrice);
			viewHolder.checked = (CheckBox) convertView.findViewById(R.id.checkBox_checked);
