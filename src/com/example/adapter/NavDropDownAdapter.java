...
public class NavDropDownAdapter extends ArrayAdapter<NavDropDownItem> {
    ...
    public NavDropDownAdapter(Context context, int ResourceId, ArrayList<NavDropDownItem> objects ) {
    ...
    public View getItemView( View convertView, ViewGroup parentView, NavDropDownItem navDropDownItem ) {
...
//        if (convertView == null) {
            convertView = inflater.inflate( R.layout.navdropdown_header, null, false);
            TextView labelView = (TextView) convertView
