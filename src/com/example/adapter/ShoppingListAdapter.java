...
public class ShoppingListAdapter extends ArrayAdapter<ShoppingList>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			listHolder.textViewTitle = (TextView) convertView.findViewById(R.id.shopping_list_textView_title);
			listHolder.textViewOutstanding = (TextView) convertView.findViewById(R.id.shopping_list_textView_outstanding);
