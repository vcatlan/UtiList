...
public class SignUpActivity extends Activity implements ValidationListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		createAccount.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
////				if((email.getText().toString().equals("") )|| (password.getText().toString().equals("")) || (firstName.getText().toString().equals(""))||
////						(lastName.getText().toString().equals("")) || (confirmPassword.getText().toString().equals(""))){
////					Toast.makeText(SignUpActivity.this, "Name/Email/Password not provided", Toast.LENGTH_SHORT).show();
////				}
//				if((email.getText().toString().compareTo("") == 0)|| (password.getText().toString().compareTo("") == 0) || (firstName.getText().toString().compareTo("") == 0)||
//						(lastName.getText().toString().compareTo("") == 0) || (confirmPassword.getText().toString().compareTo("") == 0)){
//					Toast.makeText(SignUpActivity.this, "Name/Email/Password not provided", Toast.LENGTH_SHORT).show();
//		}
//				else {
...
//					}
//					else {
//						Toast.makeText(SignUpActivity.this, "Password missmatch", Toast.LENGTH_SHORT).show();
//					}
//				}
				validator.validate();
			}
