...
public class History implements Serializable{
	...
	public History(String priceHistoryList,
			String itemNameHistoryList, String itemTodoHistoryList) {
		this.priceHistoryList = new Gson().fromJson(priceHistoryList, new TypeToken<HashSet<Double>>() {}.getType());
		this.itemNameHistoryList = new Gson().fromJson(itemNameHistoryList, new TypeToken<HashSet<String>>(){}.getType());
		this.itemTodoHistoryList = new Gson().fromJson(itemTodoHistoryList, new TypeToken<HashSet<String>>(){}.getType());
		this.ownerId = ParseUser.getCurrentUser().getObjectId();
	}
	
	public History(HistoryParser historyParser) {
		this.objectId = historyParser.getObjectId();
		this.priceHistoryList = new Gson().fromJson(historyParser.getPrice(), new TypeToken<HashSet<Double>>() {}.getType());
		this.itemNameHistoryList = new Gson().fromJson(historyParser.getItem(), new TypeToken<HashSet<String>>(){}.getType());
		this.itemTodoHistoryList = new Gson().fromJson(historyParser.getItemTodo(), new TypeToken<HashSet<String>>(){}.getType());
		this.ownerId = ParseUser.getCurrentUser().getObjectId();
	}
	...
	public CharSequence [] getItemCarSequence(){
		CharSequence [] charSequences = new CharSequence[itemNameHistoryList.size()];
		int i = 0;
	...
	public CharSequence [] getItemTodoCarSequence(){
		CharSequence [] charSequences = new CharSequence[itemTodoHistoryList.size()];
		int i = 0;
