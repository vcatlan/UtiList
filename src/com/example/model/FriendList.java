...
public class FriendList {
	...
	public FriendList(FriendListParser listParser) {
		...
		if(listParser.getItems() != null){
			this.items = new Gson().fromJson(listParser.getItems(), new TypeToken<ArrayList<FriendListItem>>() {}.getType());
		}
		this.ownerId = ParseUser.getCurrentUser().getObjectId();
	}
	...
	public FriendList(String objectId, String items,
			String ownerId) {
		this.objectId = objectId;
		if(items != null){
			this.items = new Gson().fromJson(items, new TypeToken<ArrayList<FriendListItem>>() {}.getType());
		}
		this.ownerId = ownerId;
	}
