...
public class TodoList implements Serializable{
	...
	public TodoList(String objectId, String title,
			ArrayList<TodoListItem> items, String ownerId, Date updatedDate, Date createdDate) {
	...
	public TodoList(TodoListParser listParser) {
		...
		if(listParser.getItems() != null){
			this.items = new Gson().fromJson(listParser.getItems(), new TypeToken<ArrayList<TodoListItem>>() {}.getType());
		}
		this.ownerId = ParseUser.getCurrentUser().getObjectId();
	...
	public TodoList(String objectId, String title,
			String items, String ownerId, Date updatedDate, Date createdDate) {
		this.objectId = objectId;
		this.title = title;
		if(items != null){
			this.items = new Gson().fromJson(items, new TypeToken<ArrayList<TodoListItem>>() {}.getType());
		}
		this.ownerId = ParseUser.getCurrentUser().getObjectId();
		this.updatedDate = updatedDate;
		this.createdDate = createdDate;
