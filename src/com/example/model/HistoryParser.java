...
public class HistoryParser extends ParseObject{
	...
	public HistoryParser(History history){
		...
		setItem(new Gson().toJson(history.getItemNameHistoryList(), new TypeToken<HashSet<String>>() {}.getType()));
		setPrice(new Gson().toJson(history.getPriceHistoryList(), new TypeToken<HashSet<Double>>() {}.getType()));
		setItemTodo(new Gson().toJson(history.getItemTodoHistoryList(), new TypeToken<HashSet<String>>() {}.getType()));
	}
