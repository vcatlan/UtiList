...
public class SharedList implements Serializable{
	...
	public SharedList(String listObjectId,
			String sharedByObjectId, String listTitle, String sharedByName,
			boolean newList, String listType, String sharedToObjectId) {
		this.objectId = "";
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof SharedList))
			return false;
		if((this.listObjectId.equals(((SharedList)o).getListObjectId())) && (this.sharedToObjectId.equals(((SharedList)o).getSharedToObjectId())))
			return true;
		else
			return false;	
	}
