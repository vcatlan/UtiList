...
import com.android.adapter.SharedListItemAdapter;
...
public class SharedListByFriendActivity extends Activity {
	...
	public void showList() {
		adapter = new SharedListItemAdapter(this,
				R.layout.sharedlist_display_item, sharedLists);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(SharedListByFriendActivity.this,
						ViewSharedListActivity.class);
		...
		if (sharedLists.size() == 0) {
			AlertDialog.Builder builder = new AlertDialog.Builder(
					SharedListByFriendActivity.this);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == SAHRELIST_VIEW_REC_CODE) {
			if (resultCode == Activity.RESULT_OK) {
				sharedLists = (ArrayList<SharedList>) data
						.getSerializableExtra(SHARELIST_KEY);
				adapter = new SharedListItemAdapter(
						SharedListByFriendActivity.this,
						R.layout.sharedlist_display_item, sharedLists);
				listView.setAdapter(adapter);
			}
