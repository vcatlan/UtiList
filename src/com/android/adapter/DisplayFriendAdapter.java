...
public class DisplayFriendAdapter extends ArrayAdapter<FriendListItem> {
	...
	public DisplayFriendAdapter(Context context, int resource,
			List<FriendListItem> objects,
			ICreateCallToFriendListItemClick mListener) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.checkBox = (CheckBox) convertView
					.findViewById(R.id.checkBoxToShare);
			holder.imageViewDelete = (ImageView) convertView
					.findViewById(R.id.imageViewDeleteFriend);
